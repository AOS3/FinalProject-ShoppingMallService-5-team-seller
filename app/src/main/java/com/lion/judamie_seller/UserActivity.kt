...
import com.lion.judamie_seller.databinding.ActivityUserBinding
...
class UserActivity : AppCompatActivity() {
    ...
    fun replaceFragment(fragmentName: UserFragmentName, isAddToBackStack:Boolean, animate:Boolean, dataBundle: Bundle?){
        ...
        newFragment = when(fragmentName){
            ...
            // 회원 가입 과정1 화면
            UserFragmentName.USER_REGISTER_FRAGMENT -> RegisterFragment()
            // 회원 가입 과정2 화면
            UserFragmentName.USER_REGISTER_VERIFICATION_FRAGMENT -> RegisterVerificationFragment()
        }
